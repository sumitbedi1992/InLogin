...

                {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (status == 1) {
                            ...
                            String mail = response.optString("email");

                            name.setText(firstname + " " + lastname);
                            email.setText(mail);
                            Glide.with(getApplicationContext()).load(response.optString("profile")).into(profileimage);

                            About.setText("About" + " " +  firstname + " " + lastname);
