...
public class CustomPlayerControlActivity extends YouTubeBaseActivity implements OnInitializedListener, View.OnClickListener {
    ...
    public static String API_KEY = "AIzaSyDctUSwCDCNMfnioTVJKa7DjUH_NnyeQhE";
    ...
    private TextView finaltime, start, title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titletext = getIntent().getStringExtra("Videoname");
        ...
        title = (TextView) findViewById(R.id.video_name);
        start = (TextView) findViewById(R.id.startingtimer);
        finaltime = (TextView) findViewById(R.id.finaltimer);
    ...
    PlaybackEventListener mPlaybackEventListener = new PlaybackEventListener() {
        ...
        public void onPaused() {
            findViewById(R.id.play_video).setBackgroundResource(R.drawable.ic_play_circle_outline_black_48dp);
        ...
        public void onPlaying() {
            findViewById(R.id.play_video).setBackgroundResource(R.drawable.ic_pause_circle_outline_black_48dp);
    ...
    private void displayCurrentTime() {
        ...
        finaltime.setText(formattedTime);

        start.setText(formatTime(mPlayer.getCurrentTimeMillis()));
